...
public class MainActivity extends Activity {
  static final int IMPORT_REQ=1001, EXPORT_REQ=1002, LIBRARY_PICK_REQ=1003;
  ...
  View groupCard(Group g){
    ...
    LinearLayout copy=vbox();TextView title=text(g.title,17,true,TEXT);TextView sub=text(g.sub+"  •  "+groupCount(g)+" prompts",13,false,MUTED);copy.addView(title);copy.addView(sub);card.addView(copy,new LinearLayout.LayoutParams(0,-2,1));TextView arrow=text("›",28,false,MUTED);card.addView(arrow);return card;
  }
