# Manual Review Packet — Specialist Roles — 4
...
## GID 1930 — /rebuttal
Source: community | Subcategory: Specialist Roles
Description: i have compeleted the reviewas atached.
Prompt preview: i have compeleted the reviewas atached. nowi wamt you toheck all the questiona asnweredproperlyornpt
...
Source: community | Subcategory: Specialist Roles
Description: They are standing under the rain, looking at each other romantically.
Prompt preview: They are standing under the rain, looking at each other romantically. Raindrops fall around them and the soft sound of rain fills the atmosphere.
...
Prompt preview: I want a scaryface masked man with really realistic lilke chasing me etc as cosplay
...
Prompt preview: Give me a summary of what you know about me so far
...
Prompt preview: Remove the - character and restore the split words in the markdown content.
...
Prompt preview: Write a well detailed, human written statement of purpose for a scholarship program

## GID 1177 — /Step 2: Outline Creation
Source: community | Subcategory: Specialist Roles
Description: Based on the ideas generated in the previous step, create a detailed outline.
Prompt preview: Based on the ideas generated in the previous step, create a detailed outline. Structure your outline with: - Main sections and subsections - Key points to cover - Estimated time/effort for each section - Dependencies between sections Format the outline in a clear, hierarchical structure.

## GID 1180 — /Step 4a: Implementation Plan
Source: community | Subcategory: Specialist Roles
Description: Create a comprehensive implementation plan.
Prompt preview: Create a comprehensive implementation plan. Include: - Phase breakdown with milestones - Task list with priorities - Resource allocation - Risk mitigation strategies - Timeline estimates - Success metrics Format as an actionable project plan.

## GID 1183 — /Step 6: Publication
Source: community | Subcategory: Specialist Roles
Description: Prepare the final deliverable for publication.
Prompt preview: Prepare the final deliverable for publication. Final steps: - Format for target platform - Create accompanying materials - Set up distribution - Prepare announcement - Schedule publication - Monitor initial reception Congratulations on completing the workflow!
...
Source: community | Subcategory: Specialist Roles
Description: Send the entire response as ONE uninterrupted ```markdown fenced block only.
Prompt preview: Send the entire response as ONE uninterrupted ```markdown fenced block only. No prose before or after. No nested code blocks. No formatting outside the block.
...
Prompt preview: Explain the cultural significance of ${subculture} and its impact on society.
...
## GID 703 — /Sunny Beach
Source: community | Subcategory: Specialist Roles
Description: Generate an image of people sunbathing on a sunny beach.
Prompt preview: Generate an image of people sunbathing on a sunny beach. Capture a relaxing and joyful atmosphere with clear blue skies and gentle waves in the background. Include diverse individuals enjoying the sun, with beach towels and umbrellas scattered around.
...
Source: community | Subcategory: Specialist Roles
Description: Create an image of a table with various items placed on it.
Prompt preview: Create an image of a table with various items placed on it. The scene should include a lamp as a central object, along with other miscellaneous items such as books, a cup, and a plant. Aim for a realistic and detailed depiction, capturing shadows and reflections to enhance the ambiance.
...
## GID 424 — /Temitope
Source: community | Subcategory: Specialist Roles
Description: Always act like one fill with wisdom and be extraordinary
Prompt preview: Always act like one fill with wisdom and be extraordinary
...
Prompt preview: The Mystery of Easter Island | Who Built the Giant Moai Statues? In the middle of the Pacific Ocean lies a tiny island filled with hundreds of giant stone statues. But here's the mystery... Who built them, and how were they moved without modern technology?
...
Prompt preview: Turkish Cats hanging out nearby of Galata Tower, vertical
