# Manual Review Packet — Work & Career — 1

Entries: 72

## GID 75 — /apology
Source: core | Subcategory: -
Description: يكتب اعتذارًا مناسبًا
Prompt preview: Write a sincere apology that acknowledges impact, avoids excuses, and states the corrective next step.

## GID 77 — /coverletter
Source: core | Subcategory: -
Description: يكتب خطاب تقديم
Prompt preview: Draft a tailored cover letter connecting the candidate’s evidence to the role’s actual needs.

## GID 71 — /email
Source: core | Subcategory: -
Description: يكتب بريدًا احترافيًا
Prompt preview: Draft a professional email with clear subject, purpose, context, request, and appropriate closing.

## GID 73 — /followup
Source: core | Subcategory: -
Description: يكتب رسالة متابعة
Prompt preview: Write a concise follow-up that references the prior context, asks for the needed update, and stays courteous.

## GID 78 — /interview
Source: core | Subcategory: -
Description: يحضر أسئلة مقابلة
Prompt preview: Prepare realistic interview questions, strong answer frameworks, and likely follow-up questions.

## GID 79 — /meeting
Source: core | Subcategory: -
Description: يجهزك للاجتماع
Prompt preview: Prepare the meeting: objective, agenda, key questions, decisions needed, risks, and desired outcome.

## GID 80 — /minutes
Source: core | Subcategory: -
Description: يلخص محضر الاجتماع
Prompt preview: Turn meeting notes into concise minutes with decisions, action items, owners, deadlines, and open questions.

## GID 72 — /reply
Source: core | Subcategory: -
Description: يكتب ردًا مناسبًا
Prompt preview: Draft an appropriate reply that directly addresses the message, tone, and requested action.

## GID 74 — /request
Source: core | Subcategory: -
Description: يصيغ طلبًا محترمًا
Prompt preview: Draft a respectful, specific request that explains what is needed, why, and by when if relevant.

## GID 76 — /resume
Source: core | Subcategory: -
Description: يحسن السيرة الذاتية
Prompt preview: Improve the resume for clarity, impact, relevance, measurable achievements, and ATS readability.

## GID 2983 — /Answer with STAR
Source: pdf | Subcategory: Career & Job Search
Description: Answer with STAR
Prompt preview: Help me answer this interview question using the situation, task, action, result structure, based on my experience below. Question: [question]. Experience: [paste].

## GID 2981 — /Cover letter
Source: pdf | Subcategory: Career & Job Search
Description: Cover letter
Prompt preview: Write a concise cover letter for [role] at [company], drawing on my background below, in a confident but genuine tone, under 250 words. Background: [paste].

## GID 2982 — /Interview prep
Source: pdf | Subcategory: Career & Job Search
Description: Interview prep
Prompt preview: Give me 10 likely interview questions for a [role], and for each, a one-line note on what a strong answer includes. Then ask me the first one and wait for my answer.

## GID 2984 — /LinkedIn summary
Source: pdf | Subcategory: Career & Job Search
Description: LinkedIn summary
Prompt preview: Write a LinkedIn about section for a [role] with [X] years of experience in [field], in first person, specific and warm, ending with what I am looking for. Under 150 words.

## GID 2980 — /Tailor a resume
Source: pdf | Subcategory: Career & Job Search
Description: Tailor a resume
Prompt preview: Rewrite my resume bullet points below to match this job description, using strong action verbs and quantified results, keeping them truthful. Bullets: [paste]. Job: [paste].

## GID 2241 — /automatic job apply
Source: community | Subcategory: General Work
Description: Read the email from my gmail account which gets regular email from linkedIn for job recommendations.
Prompt preview: Read the email from my gmail account which gets regular email from linkedIn for job recommendations. read the email, if it is for any suitable job match, apply for it, you may need to write or update the CV a little bit and the cover letter, email draft etc.
...
Source: community | Subcategory: Hiring & Interviews
Description: Acts as Talent Coach for interviews.
Prompt preview: I want you to act as a Talent Coach for interviews. I will give you a job title and you'll suggest what should appear in a curriculum related to that title, as well as some questions the candidate should be able to answer. My first job title is "Software Engineer".
...
Description: Act as a certified personal trainer. Build a beginner-friendly workout
Prompt preview: Act as a certified personal trainer. Build a beginner-friendly workout plan for [goal] with [days] per week and [equipment], and how to progress each week. This is general guidance, not medical advice.

## GID 2853 — /Act as a microbiology educator. Explain [topic, e.g. how vaccines work
Source: pdf | Subcategory: Imported PDF Collection
Description: Act as a microbiology educator. Explain [topic, e.g. how vaccines work
Prompt preview: Act as a microbiology educator. Explain [topic, e.g. how vaccines work, the microbiome] clearly, and correct the most common misunderstanding.

## GID 2706 — /Act as a music-career coach. Give me a realistic 90-day plan to releas
Source: pdf | Subcategory: Imported PDF Collection
Description: Act as a music-career coach. Give me a realistic 90-day plan to releas
Prompt preview: Act as a music-career coach. Give me a realistic 90-day plan to release and promote [song] as an independent artist, focused on what actually moves listeners.

## GID 2810 — /Act as a stretching coach. Give me a post-workout stretching routine f
Source: pdf | Subcategory: Imported PDF Collection
Description: Act as a stretching coach. Give me a post-workout stretching routine f
Prompt preview: Act as a stretching coach. Give me a post-workout stretching routine for [muscle groups], how long to hold, and what to avoid.

## GID 2814 — /Act as a workout-splitter. Turn my [days]-per-week schedule into an ef
Source: pdf | Subcategory: Imported PDF Collection
Description: Act as a workout-splitter. Turn my [days]-per-week schedule into an ef
Prompt preview: Act as a workout-splitter. Turn my [days]-per-week schedule into an effective training split for [goal], and what each day focuses on.

## GID 2564 — /Act as a workplace-comedy writer. Write a bit about the absurdity of [
Source: pdf | Subcategory: Imported PDF Collection
Description: Act as a workplace-comedy writer. Write a bit about the absurdity of [
Prompt preview: Act as a workplace-comedy writer. Write a bit about the absurdity of [common office ritual], finding the insanity everyone pretends is normal.

## GID 2631 — /You are a critique partner. Review my described artwork and give me th
Source: pdf | Subcategory: Imported PDF Collection
Description: You are a critique partner. Review my described artwork and give me th
Prompt preview: You are a critique partner. Review my described artwork and give me the 3 things working and the one change that would most improve it: [describe].

## GID 2803 — /You are a home-workout designer. Create a no-equipment workout for [go
Source: pdf | Subcategory: Imported PDF Collection
Description: You are a home-workout designer. Create a no-equipment workout for [go
Prompt preview: You are a home-workout designer. Create a no-equipment workout for [goal] I can do in [minutes], with a warm-up and a way to scale difficulty.

## GID 2823 — /You are a routine-variety coach. My workouts are boring. Give me ways
Source: pdf | Subcategory: Imported PDF Collection
Description: You are a routine-variety coach. My workouts are boring. Give me ways
Prompt preview: You are a routine-variety coach. My workouts are boring. Give me ways to keep [goal] training fresh so I actually stick with it.
...
Source: pdf | Subcategory: PromptOrix Use Cases
Description: ATS keyword extraction
Prompt preview: Analyze this job description and extract: - The 10 most important hard skills - 5 soft skills - Any tools, certifications, or platforms mentioned Job description: [paste JD]

## GID 3026 — /Tailor resume to a specific role
Source: pdf | Subcategory: PromptOrix Use Cases
Description: Tailor resume to a specific role
Prompt preview: Here is my master resume: [paste]. Here is the job I am applying for: [paste JD]. Rewrite my resume to be tailored for this role. Mirror their language where it accurately reflects my experience. Do not fabricate anything.
